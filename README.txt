...
Codigos para tiro parabolico CON RESISTENCIA
tiro parabolico con resistencia.m %2D
Resistencia del aire 3d.m %3D

Codigo para modelo del volcan, SOLO VOLCAN (no proyectiles)
volcan modelo.m

Estos codigos ya los combine y obtuve
volcan 3d con proyectiles (sin resistencia).m %combinando el codigo para volcan y el codigo para projectiles
